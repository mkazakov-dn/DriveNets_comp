from Mark_Net import actual
from Mark_Net import Volvo_1_actual
...
class ConfigGenerator(tk.Tk):
    ...
    def generate_config(self):
        ...
        chosen_device = actual.BaseConnector(ip='WJ31B77Y00003A2', username='dnroot')
        chosen_device.commit_backup_config('Interfaces_automated.txt')


if __name__ == "__main__":
    # Example list of interfaces
    chosen_device = actual.BaseConnector('WJ31B77Y00003A2','dnroot')
